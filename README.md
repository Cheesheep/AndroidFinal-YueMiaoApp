...
<fragment android:id="@+id/main_left_fragment"
    android:name="com.example.yuemiaoapp.homepage.HomepageFragment"
    android:layout_width="match_parent" android:layout_height="match_parent"
    android:layout_weight="3" tools:layout="@layout/fragment_main_left"
    tools:ignore="MissingConstraints" />
<!--右边碎片-->
<fragment android:id="@+id/right_frag"
    android:name="com.example.yuemiaoapp.homepage.MoreServiceFragment"
    android:layout_width="match_parent" android:layout_height="match_parent"
...
- 在main当中新建assets文件夹，并新建一个litepal.xml
  ...
  <litepal>
      ...
      <list>
          ...
          <mapping class="com.example.yuemiaoapp.entity.UserInfo"></mapping>
          <mapping class="com.example.yuemiaoapp.entity.Card"></mapping>
      </list>
  </litepal>
  ~~~
